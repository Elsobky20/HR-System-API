        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OverTimeHour = table.Column<float>(type: "real", nullable: false),
                    LateHour = table.Column<float>(type: "real", nullable: false),
                    ExtraDay = table.Column<float>(type: "real", nullable: false),
                    AbsentDay = table.Column<float>(type: "real", nullable: false),
                    FirstWeekEnd = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SecondWeekEnd = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
